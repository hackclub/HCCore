...
public class SlackBot implements Listener {
    ...
    public SlackBot(HCCorePlugin plugin) throws Exception {
        ...
        app.message(sdk, (payload, ctx) -> {
            ...
            String text = StringEscapeUtils.unescapeHtml(event.getText());
    ...
    public void onChat(AsyncPlayerChatEvent e) throws IOException {
        ...
        sendMessage(ChatColor.stripColor(e.getMessage()), getPlayerAvatarLink(player.player.getUniqueId().toString())
    ...
    public void onJoin(PlayerJoinEvent e) throws IOException {
        ...
        sendMessage("*" + ChatColor.stripColor(player.getDisplayName()) + "* joined the game!", getServerAvatarLink()
                , "Console");
    }
    ...
    public void onQuit(PlayerQuitEvent e) throws IOException {
        Player player = e.getPlayer();
        sendMessage("*" + ChatColor.stripColor(player.getDisplayName()) + "* left the game!", getServerAvatarLink(),
                "Console");
    }

    @EventHandler(priority = EventPriority.MONITOR)
    public void onDeath(PlayerDeathEvent e) throws IOException {
        sendMessage(e.getDeathMessage(), "https://cloud-4zgvoofbx-hack-club-bot.vercel.app/0image.png", "R.I.P.");
    }
