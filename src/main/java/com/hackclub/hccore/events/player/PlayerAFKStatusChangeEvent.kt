package com.hackclub.hccore.events.playerimport
...
class PlayerAFKStatusChangeEvent(player: Player?, isAfk: Boolean) : PlayerEvent(player!!) {
    val newValue: Boolean
    override fun getHandlers(): HandlerList {
        return PlayerAFKStatusChangeEvent.Companion.handlers
    }

    companion object {
        private val handlers = HandlerList()
        val handlerList: HandlerList
            get() = PlayerAFKStatusChangeEvent.Companion.handlers
    }
