...
public class DragonAdv extends BaseAdvancement {
    static AdvancementDisplayBuilder<AdvancementDisplay.Builder, AdvancementDisplay> displayBuilder = new AdvancementDisplay.Builder(Material.DRAGON_HEAD, "Dragon " +
            "Master")
            .challengeFrame()
            .announceChat()
            .showToast()
    ...
    public DragonAdv(HCCorePlugin plugin, Advancement root, AdvancementKey key, CoordAdapter adapter) {
